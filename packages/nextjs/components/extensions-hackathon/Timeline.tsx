export const Timeline = () => {
  return (
    <div className="flex flex-col w-full min-h-[120vh] lg:min-h-fit bg-accent items-center lg:justify-between border border-1 border-t-0 border-black p-12">
      <h1 className="text-4xl">Timeline</h1>
      <div className="min-w-full lg:mt-32 flex-1 flex">
